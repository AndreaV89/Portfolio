...
const projectsArray = [
    {
        ...
        description: "Startup Employee Directory. In this project I used Random User Generator API to grab information \
                    for 12 random employees, and used fetch and parse to listing the employees in a grid with their image, \
                    full name and location. Clicking the employee's image will open a modal window with more detailed information."
    },
    {
        ...
        description: "Interactive dashboard for a web application. HTML and CSS was created from scratch looking a mockup. \
                    This project is full of awesome features like notifications panel, autocomplete searching of users, \
                    implementation of chart plugin, and Local Storage for saving settings."
    },
    {
        ...
        description: "Browser version of a word guessing game. Using Javascript i've created an array of casual phrases. \
                    With a function the program will choose a phrase from that array, split the phrase into letters, and put \
                    those letters onto the game board."
    },
    {
        ...
        description: "This is a simple image gallery. Clicking on images will open a lightbox with larger image and caption.\
                    The user can search for an image using the search box, that filter the images in real time."
    },
    {
        ...
        skills: "#HTML, #CSS",
        description: "Really simple online registration form example. Is fully responsive and mobile-friendly. Here is a \
                    wide variety of HTML form input types, like text input, checkboxes, radio buttons, select menu and so on."
    }
];
...
$(document).ready(function() {
    $('#pagepiling').pagepiling({
        ...
        sectionsColor: ['#222222','#222222','#222222','#222222'],
        loopBottom: true,
    });
});
